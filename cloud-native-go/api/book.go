...
var books = map[string]Book{
	"123123": Book{Title: "Jupiters Travels", Author: "Ted Simons", ISBN: "123123"},
	"323232": Book{Title: "CLoud Go", Author: "Nithin C", ISBN: "323232"},
}
...
func BooksHandleFunc(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPost:
		...
		if created {
			w.Header().Add("Location", "/api/boks/"+isbn)
